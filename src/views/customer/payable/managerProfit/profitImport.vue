<template>
    <div>
        <div class="overflow-box" style="width:594px;" >
            <div class="box-title"><span>导入调整项(项目经理利润{{batchNumber}})</span></div>
            <div class="box-body1">
                <div class="box-body-item">
                    <div class="box-body-form">
                    <el-form ref="form" :model="form" label-width="135px" label-position="right" :rules="rules" style="margin: 120px 0;">
                        ...
                        <div class="import-label">
                            <span class="el-form-item__label" style="width: 135px;"> 注意：</span>
                            <span style="line-height: 40px;">1，项目经理利润已发放后，会导入失败</span>
                            <div style="margin-left: 135px"> 2，对应发放批次内存在未付款的应收或应付记录，会导入失败</div>
                            <div style="margin-left: 135px"> 3，当调整后实发利润小于0时，该条调整项会导入失败</div>
                            <div style="margin-left: 135px"> 4，调整项重复时，后导入的会覆盖前面导入的金额</div>
                            <br/>
...
//            { validator: validateRepeatC, trigger: 'blur' }
    ...
    mounted(){
      ...
      this.profitImport=this.$importBaseURL+'project/adjust/profit/import'
    ...
    methods: {
      ...
      DownLoad(){
        this.$api.profitDownload().then((response) => {
