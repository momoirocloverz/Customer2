  ...
  <div class="taskBaseInfoCon">
    <div class="box-body-item">
      <div class="table-info info-item">
        ...
        <div class="table-info-col2"><span>{{this.form.expectPieceSize}}</span></div>
        <div class="table-info-col1"><span>预估总价</span></div>
        <div class="table-info-col2"><span>{{this.form.expectMoney}}</span></div>
        <div class="table-info-col1"><span>挂靠费</span></div>
        <div class="table-info-col2"><span>{{this.$route.query.hookRate}}%</span></div>
...
export default {
  ...
  methods: {
    getDetail() {
      const params = {
        id: this.$route.query.assignmentInfoId,
      }
