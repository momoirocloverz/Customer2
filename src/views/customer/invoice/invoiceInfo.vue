<template>
  <div>
    ...
    >
      <el-button size="medium" style="font-size:12px;" @click="prevPage">取消</el-button>
      <el-button size="medium" type="primary" style="font-size:12px;" @click="submitPrev" :disabled="submitDisabled">提 交</el-button>
    </h1>
    <!-- 窗窗 -->
