<template>
    <div class="choose-task">
        ...
        <div class="dialog-footer-center"
             style="color:#383838;font-size:14px;padding:20px 0 20px 30px;background: #ffffff;">
...
<script>
    ...
    export default {
        ...
        computed: {
            ...mapGetters(['getSelectClassList','getSelectClassTotal'])
        },
        created() {
            this.getListOld(0);
            // this.getListOld(1);
        ...
        methods: {
            cancelList() {
                console.log(1);
                this.dataList = this.getSelectClassList;
                this.selectTotal = this.getSelectClassTotal;
            ...
            getListOld(index) {
                ...
                _this.$api.analyTaskList({
                    ...
                    if (parseInt(res.respCode) === 0) {
                        ...
                        this.$store.commit('SET_SELECT_CLASS_LIST', dataList);
                        this.$store.commit('SET_SELECT_CLASS_TOTAL', this.selectTotal);
           ...
           * 跳转
            */
            goToPage() {
                ...
                this.$store.commit('SET_SELECT_CLASS', [...nextList]);
                let dataClassList = JSON.parse(JSON.stringify(this.dataList))
                this.$store.commit('SET_SELECT_CLASS_LIST', dataClassList);
                this.$store.commit('SET_SELECT_CLASS_TOTAL', this.selectTotal);
