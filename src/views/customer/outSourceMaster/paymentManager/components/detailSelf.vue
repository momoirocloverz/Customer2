    ...
    <div class="marketReceiveNormalDetailCon">        
        ...
        <div class="tableCon">
            <el-table :data="tableData" style="width: 100%">
                ...
                <el-table-column prop="price" show-overflow-tooltip label="班务单价" :formatter="priceFormatter"></el-table-column>
                <el-table-column prop="taskIncome" label="金额" show-overflow-tooltip>
                    <template v-slot="scope">
