...
//                    this.form.timeOut = '00:00';
  ...
  methods: {  
      ...
      freshParseAndSetData(){
          ...
          let superMan = shazam.outThusTaskDetail;
          console.log( superMan );
          let userInfo = JSON.parse(localStorage.getItem('userInfo'));
          this.form.fullName = userInfo.customerName;
          
          this.taskName = shazam.outaskName;
          this.form.classifyName = shazam.outaskName+'('+(shazam.outClassListLen+1)+')';
    ...
    handleInitForm(){
        let sessionExists = sessionStorage.getItem('shortCutFirstOut');
        if(sessionExists){
   ...
   const $params = {
          ...
          if (valid) {
              ...
              if(endTime&&this.Moment(startTime)-this.Moment(endTime)>=0){
                ...
                this.$message({
                  ...
                  console.log( $params ); 
                  sessionStorage.setItem( 'shortCutFirstOut',JSON.stringify($params) );            
    ...
    handleSave(params,str){ 
        this.$store.commit('setShortCutIndexOut',2);
    },
    savePriceForm(){
