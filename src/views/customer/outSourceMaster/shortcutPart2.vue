...
export default {
  ...
  methods: {   
      ...
      goBack(){
          ...
          sessionStorage.setItem( 'shortCutSecOut',JSON.stringify(this.tableData) ); 
      },
      nextStep(){
          if( this.tableData.length ){
              ...
              if( flag ){
                  sessionStorage.setItem( 'shortCutSecOut',JSON.stringify(this.tableData) ); 
                  this.$store.commit('setShortCutIndexOut',3);
              }else{
      ...
      deleteThis(item,index){ 
          ...
          let unique2 = JSON.parse(sessionStorage.getItem('secSelectOut'));  
          ...
          sessionStorage.setItem('secSelectOut',JSON.stringify(unique2)); 
      ...
      handleSelectionChange(val){ 
          ...
          let parseData = JSON.parse(sessionStorage.getItem('secSelectOut'));
      ...
      addMoreWorker(){
          ...
          this.currentPage = 1;
          this.getWorkerListSp();           
          sessionStorage.setItem('secSelectOut',JSON.stringify(this.tableData));          
      ...
      shutDelete(){          
          ...
          this.calucateFinal();
          if( sessionStorage.getItem( 'shortCutSecOut') ){
              sessionStorage.setItem( 'shortCutSecOut',JSON.stringify(this.tableData) ); 
          }
      },
      ...
      analyse(){
          let resource = JSON.parse(sessionStorage.getItem( 'shortCutFirstOut'));
      ...
      getSeStorage(){
          if( sessionStorage.getItem( 'shortCutSecOut') ){
              this.tableData = JSON.parse( sessionStorage.getItem( 'shortCutSecOut') );
              this.calucateFinal();
          }
      },                      
      setOption(){
