<template>
  <div class="back-white outScheduleListConLimit">
    ...
    <div class="table-box back-white">
      <el-table :data="tableData" empty-text="暂无相关排班信息">
        <el-table-column type="expand">
          <template v-slot="scope">
            <div class="table-style">
              ...
              <div class="table-tr">
                <p class="table-td"><span class="td-title">核定人数：</span>{{scope.row.authorizedNumber}}人</span></p>                
        ...
        <el-table-column label="状态" prop="schedulingStatus" show-overflow-tooltip align="center" min-width="100"></el-table-column>
