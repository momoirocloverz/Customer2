<template>
  <div class="g-a-p-list" v-loading="loading" :element-loading-text="loadingText">
    ...
    <search-bar combCondition="true" :showSelect="true"  slectPlaceholder="奖惩对象" :shusOptions="shusOptions" @handleSearch="handleSearch" @handleSelect="handleSelect" placeholder="根据下拉框选项输入关键字搜索">
      <el-form ref="rulesForm" label-width="100px" labelPosition="left">
        ...
        <el-form-item label="奖惩类型:" class="formSearchMargin">
          <el-radio-group class="radio-search" v-model="dicVal" @change="handleDicValChange" style="width: 100%;display:flex;flex-wrap: wrap;">
    ...
    <div class="flex-between pl20 pr20 pt10 pb10">
        <el-button class="primary-btn" :disabled="rewardAndPunishList.length === 0" size="mini" @click="exportData()">导出数据</el-button>
    </div>
