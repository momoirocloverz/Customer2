    ...
    <div class="marketReceiveNormalDetailCon"> 
        ...
        <div class="tableCon">
            <el-table :data="tableData" style="width: 100%">
                ...
                <el-table-column prop="date" label="排班产量">
                    <template v-slot="scope">
                        <span>{{ bridge(scope.row.cusPieceSizeTotal) }}</span>
                      </template>
                </el-table-column>
                <el-table-column prop="price" label="任务单价"  :formatter="priceFormatter" ></el-table-column>
                ...
                <el-table-column label="操作" >
                    <template v-slot="scope">
                        <div v-if="scope.row.confirmPdfForm">
...
<script>
    export default {
        ...
        methods: {
            ...
            checkDetail(row){
                window.open(row.confirmPdfForm, '_blank');
            },
