    ...
    <div class="billCollectContainer">
        ...
        <div class="table-box back-white">
            <el-table class="table-outline" :data="tableData" emptyText="暂无相关信息" style="width: 100%;">
                ...
                <el-table-column label="上期余额" prop="previousBalance" :formatter="moneyFormat"></el-table-column>
                ...
                <el-table-column label="支出">
                    ...
                    <!--            <el-table-column  prop="labourFee"  label="外包费用" :formatter="moneyFormat"></el-table-column>-->
                    ...
                    <!--            <el-table-column  prop="memberFee"  label="会员费" :formatter="moneyFormat"></el-table-column>-->
                    ...
                    <!--            <el-table-column  prop="labourServiceFee"  label="外包手续费" :formatter="moneyFormat"></el-table-column>-->
                    <el-table-column prop="outAmount" label="合计" :formatter="moneyFormat"></el-table-column>
                </el-table-column>
                <el-table-column label="期末余额" prop="balance" :formatter="moneyFormat"></el-table-column>
            </el-table>
                ...
                this.$api.getAccountRecordSum(params).then(res => {
                    ...
                    if (respCode === 0) {
                        if (data.list) {
                            ...
                            let obj = {};
                            let arr = ['recharge', 'rechargeTotal', 'rechargeCharges', 'labourFee', 'wages', 'managementExpense', 'memberFee', 'cashFee', 'cashServiceFee', 'labourServiceFee', 'inAmount', 'outAmount', 'payFee', 'attendanceFee', 'insurance', 'systemFee'];
                            arr.forEach(ele => {
