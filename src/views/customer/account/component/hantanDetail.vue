    ...
    <div class="xfd-detail">
        <el-form ref="formDetail" :model="formDetail" label-width="100px" labelPosition="left" style="background-color:white;padding-left:20px;padding-bottom: 15px">
            ...
            <div class="f14 pb10 pt10 co-666">
                合计: 成功发放{{successInfo.successAmount}}人 ; {{successInfo.totalRealFee}}元   <span class="pl20">发放失败{{successInfo.failAmount}}人 ; {{successInfo.totalFailFee}}元</span>
            </div>
        </el-form>
    ...
    export default {
        ...
        methods:{
            ...
            getList(){
                ...
                this.$api.htOrders(params).then(res=>{
                    if(res.respCode === 0){
