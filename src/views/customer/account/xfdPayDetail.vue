<template>
    <div style="background-color:#f2f2f5;" class="xfd-pay-detail" v-loading="loading" element-loading-text="正在导出中...">
        <el-form label-width="100px" labelPosition="left" style="background-color:white;padding-left:20px;padding-bottom: 15px">
            ...
            <div class="f14 pb10 co-666 xfd-flex pr20">
                <div>
                    合计: <span class="pl20">成功发放{{successInfo.totalCount}}人 ; 应发{{successInfo.totalFee}}元; </span>
                    <span class=""> 实发{{successInfo.totalRealFee}}元</span>
                </div>
        ...
        <div class="table-box back-white">
            <el-table class="table-outline" :data="tableData"
                ...
                <el-table-column align="center" :formatter="_number" label="信息服务费(元)" prop="serviceFee"></el-table-column>
                <el-table-column align="center" :formatter="_number" label="薪福多应发收入(元)" prop="deductMoney"></el-table-column>
                <el-table-column align="center" :formatter="_number" label="个人所得税(元)" prop="tax"></el-table-column>
                <el-table-column align="center" :formatter="_number" label="薪福多实际到账(元)" prop="money"></el-table-column>
                <!--<el-table-column align="center" :formatter="_number" label="薪福多本月已付收入(元)" prop="alreayPay"></el-table-column>-->
                <!--<el-table-column align="center" :formatter="_number" label="薪福多本月已付个税(元)" prop="alreayTax"></el-table-column>-->
                <el-table-column align="center"  label="是否冻结" prop="freeStatus" :formatter="freeFormatter"></el-table-column>
                <el-table-column align="center"  label="发放状态" prop="status" :formatter="settlementTypeFormatter"></el-table-column>
    ...
    export default {
        ...
        methods: {
            ...
            exportExce(){
                ...
                this.$api.xfdOrdersDetailsExport(params).then(res=>{
                    if(res.respCode === 0){
            ...
            getList(){
                    ...
                    this.$api.xfdOrdersDetails(params).then(res=>{
                        if(res.respCode === 0){
                            this.successInfo = {totalCount:res.data.xfdOrderDO.successAmount,totalFee:res.data.xfdOrderDO.totalFee,totalRealFee:res.data.xfdOrderDO.totalRealFee} || {};
